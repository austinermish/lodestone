...
const UPDATE_MANIFEST_URLS = [
	"https://github.com/Opkalla/yaos/releases/latest/download/update-manifest.json",
] as const;
...
function buildGithubOpsBootstrapWorkflowYaml(): string {
	return [
		...
		"      release_repo: { type: string, required: false, default: Opkalla/yaos }",
		"permissions:",
		"  contents: write",
		"jobs:",
		"  run:",
		"    uses: Opkalla/yaos/.github/workflows/yaos-ops-reusable.yml@main",
		"    with:",
