...
That means future pushes to your generated repo will redeploy automatically, but future pushes to the original `Opkalla/yaos` template repo will not update your existing Worker on their own.
